...
public class SyncMaster
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            masterTable = DatabaseBuilder.open(masterFile).getTable("Master");
            ...
            while (!isDone)
            {
                if (masterCursor.moveToNextRow() && gatorCursor.moveToNextRow())
                {
                    Row gatorRow = gatorCursor.getCurrentRow();
                    Row masterRow = masterCursor.getCurrentRow();
                    
                    if (gatorRow.get("ID").toString().equals(masterRow.get("ID").toString()))
                    {
